...
export async function POST(req: NextRequest) {
    try {
        ...
        await sendConfirmationEmail(validatedData.email, validatedData.name, validatedData.service, validatedData.date, validatedData.time, newBooking.id, validatedData.locale as any);
        }
