        ...
        <footer className='bg-[#F2EDE4]cborder-t border-[#10069F]/5 py-12'>
          <div className='max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center px-6 gap-8'>
           ...
           <div className='flex gap-6 items-center'>
              <a href='https://www.instagram.com/vitamosondz_nailspace_manicure?igsh=MWdlb2NieTF2a280Yg==' className='text-[#10069F]/70 hover:text-[#10069F] transition-colors duration-300 focus:outline-none'>
