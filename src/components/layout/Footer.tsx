          ...
          <div className='max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center px-6 gap-4'>
           ...
           <div className='flex gap-4'>
              <a href='#' className='hover:text-pink-500'>
                <svg className='w-8 h-8 stroke-current fill-current'><use href='#icon-instagram'/></svg>
              </a>
              <a href='#' className='hover:text-pink-500'><svg className='w-8 h-8  fill-current'><use href='#icon-facebook'/></svg></a>
              <a href='#' className='hover:text-pink-500'><svg className='w-8 h-8  fill-current'><use href='#icon-phone'/></svg></a>
           </div>
           <div>
